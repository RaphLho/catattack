...
<head>
    ...
    <title>CatAttack - Niveau 4</title>
    ...
    <script>
        ...
        function generateTerrain() {
            terrain = [
                ...
                { type: 'platform', x: 700, y: canvas.height - 350, width: 150, height: 20, image: moovingPlatformImage },
                { type: 'platform', x: 1000, y: canvas.height - 150, width: 250, height: 20, image: highPlatformImage },
                { type: 'platform', x: 1400, y: canvas.height - 300, width: 180, height: 20, image: platformImage },
                { type: 'platform', x: 1700, y: canvas.height - 200, width: 220, height: 20, image: moovingPlatformImage },
                { type: 'platform', x: 2000, y: canvas.height - 400, width: 160, height: 20, image: highPlatformImage },
                { type: 'platform', x: 2300, y: canvas.height - 250, width: 200, height: 20, image: platformImage },
                { type: 'platform', x: 2600, y: canvas.height - 350, width: 180, height: 20, image: moovingPlatformImage },
                { type: 'platform', x: 2900, y: canvas.height - 150, width: 240, height: 20, image: highPlatformImage },
                { type: 'platform', x: 3200, y: canvas.height - 250, width: 190, height: 20, image: platformImage },
                { type: 'platform', x: 3500, y: canvas.height - 350, width: 170, height: 20, image: moovingPlatformImage },
                { type: 'platform', x: 3800, y: canvas.height - 200, width: 210, height: 20, image: highPlatformImage },
                { type: 'platform', x: 4100, y: canvas.height - 300, width: 160, height: 20, image: platformImage },
                { type: 'platform', x: 4400, y: canvas.height - 400, width: 150, height: 20, image: moovingPlatformImage },
                { type: 'platform', x: 4700, y: canvas.height - 250, width: 200, height: 20, image: highPlatformImage },
                { type: 'platform', x: 5000, y: canvas.height - 350, width: 180, height: 20, image: platformImage },
                { type: 'platform', x: 5300, y: canvas.height - 450, width: 140, height: 20, image: moovingPlatformImage },
                { type: 'platform', x: 5600, y: canvas.height - 200, width: 220, height: 20, image: highPlatformImage },
                { type: 'platform', x: 5900, y: canvas.height - 300, width: 190, height: 20, image: platformImage },
                { type: 'platform', x: 6200, y: canvas.height - 400, width: 130, height: 20, image: moovingPlatformImage },
                { type: 'platform', x: 6500, y: canvas.height - 250, width: 210, height: 20, image: highPlatformImage },
                { type: 'platform', x: 6800, y: canvas.height - 350, width: 120, height: 20, image: platformImage },
                { type: 'platform', x: 7100, y: canvas.height - 450, width: 110, height: 20, image: moovingPlatformImage },
                { type: 'platform', x: 7400, y: canvas.height - 200, width: 200, height: 20, image: highPlatformImage },
                { type: 'platform', x: 7700, y: canvas.height - 300, width: 100, height: 20, image: platformImage },
                { type: 'platform', x: 8000, y: canvas.height - 400, width: 90, height: 20, image: moovingPlatformImage },
                { type: 'platform', x: 8300, y: canvas.height - 250, width: 230, height: 20, image: highPlatformImage },
                { type: 'platform', x: 8600, y: canvas.height - 350, width: 150, height: 20, image: platformImage },
                { type: 'platform', x: 8900, y: canvas.height - 450, width: 140, height: 20, image: moovingPlatformImage },
                { type: 'platform', x: 9200, y: canvas.height - 200, width: 220, height: 20, image: highPlatformImage },
            ...
            spikes = [
                ...
                { x: 9600, y: canvas.height - 200 - 37, width: 40, height: 40 },
            ];
